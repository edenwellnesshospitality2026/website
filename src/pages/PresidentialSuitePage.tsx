  ...
  const collections = [
    {
      ...
      description:
        "The Presidential Suite is our most expansive residence—designed for distinguished stays with generous living and dining areas, multiple bedrooms, premium finishes, and elevated valley-facing spaces. Ideal for extended visits, family gatherings, or when only the highest level of comfort and privacy will do.",
      features: [
        "Multiple bedrooms & suites",
        "Private lounge & dining",
        "Fully equipped premium kitchen",
        "Terraces with panoramic views",
        "Wi-Fi & workspace",
        "Air conditioning (hot & cold)",
        "Priority housekeeping",
        "Complimentary breakfast",
        "Full resort amenities access",
      ],
      recommendation:
        "Recommended for: Guests seeking our flagship experience—maximum space, privacy, and elevated hospitality in the Dehradun valley.",
    },
  ];
  ...
  if (showForm) {
    const mockBookingDetails: any = {
      roomType: {
        ...
        guests: 6,
        startingPrice: 35000,
        description: "Flagship Presidential residence",
        amenities: [],
      },
      roomCategory: {
      ...
      totalPrice: packageDetails?.totalPrice || 35000,
    };
      ...
      <section className="relative h-96 flex items-center justify-center">
        ...
        <div className="relative z-10 text-center text-white">
          ...
          <p className="text-xl font-light">
            Our flagship residence for elevated stays in the Dehradun valley
          </p>
        </div>
      </section>
